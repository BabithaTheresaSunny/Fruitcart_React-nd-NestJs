...
let NotesController = class NotesController {
    constructor(notesService, userService) {
        this.notesService = notesService;
        this.userService = userService;
    }
    async create3(createNoteDto) {
    ...
    async findNotesofSpecificUser(id) {
...
], NotesController.prototype, "create3", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)('userInNotes/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NotesController.prototype, "findNotesofSpecificUser", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
